...
// ConfigAPIInterface is a subset of gitpod.APIInterface used by ConfigService
type ConfigAPIInterface interface {
	GetWorkspace(ctx context.Context, id string) (res *gitpod.WorkspaceInfo, err error)
}

// NewConfigService creates a new instance of ConfigService
func NewConfigService(workspaceID string, configService gitpod.ConfigInterface, gitpodAPI ConfigAPIInterface) *ConfigService {
